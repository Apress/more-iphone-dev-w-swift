...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.ozapps.SuperDB" in the application's documents Application Support directory.
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), {
            ...
            if (ubiquityToken != nil && ubiquityURL != nil) {
                ...
                if fileManager.fileExistsAtPath(dataDirPath!) == false {
                    ...
                    fileManager.createDirectoryAtPath(dataDirPath!, withIntermediateDirectories: true, attributes: nil, error: &fileSystemError)
                ...
                newStore = psc.addPersistentStoreWithType(NSSQLiteStoreType, configuration: nil, URL: dataFileURL, options: options as [NSObject : AnyObject], error: &error)
...
//        return managedObjectContext
        ...
        var managedObjectContext = NSManagedObjectContext()
        managedObjectContext.persistentStoreCoordinator = coordinator
        NSNotificationCenter.defaultCenter().addObserver(self, selector: "mergeChangesFromUbiquitousContent:", name: NSPersistentStoreDidImportUbiquitousContentChangesNotification, object: coordinator)
        return managedObjectContext
    }()
